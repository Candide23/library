...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    async function increaseQuantity() {
        ...
        const url = `http://librarymk.us-east-2.elasticbeanstalk.com/api/admin/secure/increase/book/quantity/?bookId=${props.book?.id}`;
    ...
    async function decreaseQuantity() {
        ...
        const url = `http://librarymk.us-east-2.elasticbeanstalk.com/api/admin/secure/decrease/book/quantity/?bookId=${props.book?.id}`;
        const requestOptions = {
            method: 'PUT',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
    ...
    async function deleteBook() {
        ...
        const url = `http://librarymk.us-east-2.elasticbeanstalk.com/api/admin/secure/delete/book/?bookId=${props.book?.id}`;
        const requestOptions = {
            method: 'DELETE',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
