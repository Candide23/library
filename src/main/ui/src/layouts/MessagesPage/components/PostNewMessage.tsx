...
export const PostNewMessage = () => {
    ...
    /*The submitNewQuestion() is an asynchronous function in a React application that sends a POST request 
    to an API endpoint to submit a new question. It checks if the user is authenticated and if the title and
     question variables are not empty before sending the request. If the submission is successful, it resets 
    ...
    return (
        <div className='card mt-3'>
            <div className='card-header'>
                Ask question to MBK Read Admin
            </div>
